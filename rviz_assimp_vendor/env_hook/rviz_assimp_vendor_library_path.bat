:: copied from rviz_assimp_vendor/env_hook/rviz_assimp_vendor_library_path.bat
@echo off

call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\rviz_assimp_vendor\bin"
